...
zip --symlink -r apollo-mariadb-$MARIADB_VER-Windows-X86_64.zip ApolloWallet
sha256sum  apollo-mariadb-$MARIADB_VER-Windows-X86_64.zip >  apollo-mariadb-$MARIADB_VER-Windows-X86_64.zip.sha256
